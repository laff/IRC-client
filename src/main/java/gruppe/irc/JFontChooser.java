...
import static gruppe.irc.JFontChooser.CANCEL_OPTION;
import static gruppe.irc.JFontChooser.DialogCancelAction.ACTION_NAME;
import static gruppe.irc.JFontChooser.ERROR_OPTION;
import static gruppe.irc.JFontChooser.OK_OPTION;
...
public class JFontChooser extends JComponent
{
	...
	public JTextField getFontFamilyTextField()
	{
		if (fontFamilyTextField == null)
		{
			...
			fontFamilyTextField.addFocusListener(
				new JFontChooser.TextFieldFocusHandlerForTextSelection(fontFamilyTextField));
			fontFamilyTextField.addKeyListener(
				new JFontChooser.TextFieldKeyHandlerForListSelectionUpDown(getFontFamilyList()));
			fontFamilyTextField.getDocument().addDocumentListener(
				new JFontChooser.ListSearchTextFieldDocumentHandler(getFontFamilyList()));
	...
	public JTextField getFontStyleTextField()
	{
		if (fontStyleTextField == null)
		{
			...
			fontStyleTextField.addFocusListener(
				new JFontChooser.TextFieldFocusHandlerForTextSelection(fontStyleTextField));
			fontStyleTextField.addKeyListener(
				new JFontChooser.TextFieldKeyHandlerForListSelectionUpDown(getFontStyleList()));
			fontStyleTextField.getDocument().addDocumentListener(
				new JFontChooser.ListSearchTextFieldDocumentHandler(getFontStyleList()));
	...
	public JTextField getFontSizeTextField()
	{
		if (fontSizeTextField == null)
		{
			...
			fontSizeTextField.addFocusListener(
				new JFontChooser.TextFieldFocusHandlerForTextSelection(fontSizeTextField));
			fontSizeTextField.addKeyListener(
				new JFontChooser.TextFieldKeyHandlerForListSelectionUpDown(getFontSizeList()));
			fontSizeTextField.getDocument().addDocumentListener(
				new JFontChooser.ListSearchTextFieldDocumentHandler(getFontSizeList()));
	...
	public JList getFontFamilyList()
	{
		if (fontNameList == null)
		{
			...
			fontNameList.addListSelectionListener(
				new JFontChooser.ListSelectionHandler(getFontFamilyTextField()));
	...
	public JList getFontStyleList()
	{
		if (fontStyleList == null)
		{
			...
			fontStyleList.addListSelectionListener(
				new JFontChooser.ListSelectionHandler(getFontStyleTextField()));
	...
	public JList getFontSizeList()
	{
		if (fontSizeList == null)
		{
			...
			fontSizeList.addListSelectionListener(
				new JFontChooser.ListSelectionHandler(getFontSizeTextField()));
	...
	{
		return IRCClient.messages.getString("jfont.version");
	}
		...
		private void update(DocumentEvent event)
		{
			...
			if (newValue.length() > 0)
			{
				...
				if (newValue.equalsIgnoreCase(matchedName))
				{
					...
					{
						SwingUtilities.invokeLater(new JFontChooser.ListSearchTextFieldDocumentHandler.ListSelector(index));
					}
				}
			}
		}
	...
	protected JDialog createDialog(Component parent)
	{
		...
		JDialog dialog = new JDialog(frame, IRCClient.messages.getString("jfont.selectFont"), true);

		Action okAction = new JFontChooser.DialogOKAction(dialog);
		Action cancelAction = new JFontChooser.DialogCancelAction(dialog);
	...
	protected JPanel getFontFamilyPanel()
	{
		if (fontNamePanel == null)
		{
			...
			JLabel label = new JLabel(IRCClient.messages.getString("jfont.fontName"));
	...
	protected JPanel getFontStylePanel()
	{
		if (fontStylePanel == null)
		{
			...
			JLabel label = new JLabel(IRCClient.messages.getString("jfont.fontStyle"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getFontSizePanel()
	{
		if (fontSizePanel == null)
		{
			...
			JLabel label = new JLabel(IRCClient.messages.getString("jfont.fontSize"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getSamplePanel()
	{
		if (samplePanel == null)
		{
			Border titledBorder = BorderFactory.createTitledBorder(
				BorderFactory.createEtchedBorder(), IRCClient.messages.getString("jfont.sample"));
	...
	protected JTextField getSampleTextField()
	{
		if (sampleText == null)
		{
			...
			sampleText = new JTextField(IRCClient.messages.getString("jfont.sampleString"));
	...
	protected String[] getFontStyleNames()
	{
		if (fontStyleNames == null)
		{
			...
			fontStyleNames[i++] = IRCClient.messages.getString("jfont.plain");
			fontStyleNames[i++] = IRCClient.messages.getString("jfont.bold");
			fontStyleNames[i++] = IRCClient.messages.getString("jfont.italic");
			fontStyleNames[i++] = IRCClient.messages.getString("jfont.boldItalic");
		}
